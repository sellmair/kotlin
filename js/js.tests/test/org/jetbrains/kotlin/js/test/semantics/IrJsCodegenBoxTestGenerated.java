...
public class IrJsCodegenBoxTestGenerated extends AbstractIrJsCodegenBoxTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Extensionresolution extends AbstractIrJsCodegenBoxTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest0(this::doTest, TargetBackend.JS_IR, testDataFilePath);
        }

        public void testAllFilesPresentInExtensionresolution() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/box/extensionresolution"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JS_IR, true);
        }
    }
